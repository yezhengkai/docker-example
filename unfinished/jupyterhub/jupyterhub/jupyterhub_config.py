...
c.Application.log_level = "DEBUG"  #"INFO"
...
c.Authenticator.minimum_password_length = 6  #10
c.Authenticator.allowed_failed_logins = 10
c.Authenticator.ask_email_on_signup = False  # True
...
#c.JupyterHub.hub_ip = '172.17.0.1'  #error
#c.JupyterHub.hub_ip = os.environ['HUB_IP']  #OK
c.JupyterHub.hub_ip = '0.0.0.0'  #OK
...
c.JupyterHub.ip = os.environ['HUB_IP']  # '127.0.0.1'
...
#c.JupyterHub.proxy_api_ip = '193.190.204.72'
...
#          }
#      ]
# see https://github.com/jupyterhub/jupyterhub-idle-culler
...
#    ('Docker Python 3 Scipy', 'scipy-notebook', 'dockerspawner.DockerSpawner', dict(image="jupyter/scipy-notebook:hub-1.4.2", network_name=os.environ['DOCKER_NETWORK_NAME']),
#    ('Matlab', 'matlab-vnc', 'dockerspawner.DockerSpawner', dict(image=os.environ['DOCKER_JUPYTER_IMAGE'], network_name=os.environ['DOCKER_NETWORK_NAME'])),
#]
# ===============

# ===== modified from plutohub-juliacon2021 =====
c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'
c.DockerSpawner.image = os.environ['DOCKER_JUPYTER_IMAGE']
c.DockerSpawner.network_name = os.environ['DOCKER_NETWORK_NAME']

def format_google_volume_name(template, spawner):
    return template.format(username=spawner.user.name).replace("@","_at_")

c.DockerSpawner.format_volume_name = format_google_volume_name

host_root_dir = "replace_your_path_in_host_here"  # "/path/on/host"
host_notebook_dir = os.path.join(host_root_dir, "jupyterhub-user-{username}")  # "/path/on/host"
notebook_dir = os.environ.get('DOCKER_NOTEBOOK_DIR') or '/home/jovyan/work'  # "/path/in/dockerinstance"
c.DockerSpawner.notebook_dir = notebook_dir

c.DockerSpawner.volumes = {host_notebook_dir: {"bind": notebook_dir, "mode": "rw"}}
# c.DockerSpawner.read_only_volumes = { 'replace_your_path_in_host_here': 'replace_path_in_container_here' }
# e.g. c.DockerSpawner.read_only_volumes = { '/home/user/my-coursefiles': '/home/jovyan/work/coursefiles' }

c.DockerSpawner.remove = True  # remove containers
...
c.DockerSpawner.environment = {
    "GRANT_SUDO": "yes",
    "CHOWN_HOME": "yes",
    "CHOWN_EXTRA": os.environ.get('DOCKER_NOTEBOOK_DIR', "/home/jovyan/work"),
#    "CHOWN_HOME_OPTS": "-R",
    "NB_UID": 1000,
    "NB_GID": 1000,
}
...
#  
#  Use with ssl_key
#c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/myserver.com/fullchain.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  Use with ssl_cert
#c.JupyterHub.ssl_key = '/etc/letsencrypt/live/myserver.com/privkey.pem'
...
#c.Authenticator.whitelist = set(["barche@gmail.com", "ben.lauwens@gmail.com"])
